      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8 lg:px-12">
        ...
        <div className="max-w-2xl mx-auto bg-background rounded-2xl p-8 md:p-12 shadow-sm border border-border/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button type="submit" size="lg" className="w-full bg-accent hover:bg-accent/90 text-white rounded-full font-bold text-xl" data-testid="button-contact-submit">
        ...
        <p className="text-sm text-center font-medium text-accent mt-6" data-testid="text-early-adopters">
